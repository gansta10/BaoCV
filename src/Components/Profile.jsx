    ...
    <section className="home section" id="home">
      ...
      <div className="home__container bd-grid">
        ...
        <div className='home__contact bd-grid'>
          ...
          <BoxIcon className="home__icon bx-envelope" label={`Send an email to me: ${email}`} url={`mailto:${email}`} />
          <BoxIcon className="home__icon bx-phone" label={`Send a call to my phone number: ${telephone}`} url={`tel:${telephone}`} />
